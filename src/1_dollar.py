                ...
                for i in range(100):
                    ...
                    for gesture in gestures:              
                        for j in range(1, E + 1):
                            ...
                            this_template = possible_template.pop(random.randint(0, len(possible_template) - 1))
                            templates[gesture].append(this_template)

                            # choose 1 candidate from remaining templates
                            this_candidate = possible_template.pop(random.randint(0, len(possible_template) - 1))
